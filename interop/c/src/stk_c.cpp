...
stk_timeout_t stk_ticks_from_ms_clamped_to_timeout(stk_timeout_t ms) { return static_cast<stk_timeout_t>(stk::GetTicksFromMsClampedToTimeout(static_cast<stk::Timeout>(ms))); }
